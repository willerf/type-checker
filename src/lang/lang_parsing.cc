...
static const std::map<NonTerminal, std::vector<Production>> productions = {
    ...
    {NonTerminal::vardef, {{NonTerminal::vardef, {Terminal::ID}}}},
    {NonTerminal::stmtblock,
     {{NonTerminal::stmtblock,
    ...
    {NonTerminal::p1,
     {{NonTerminal::p1, {NonTerminal::p2}},
      {NonTerminal::p1, {NonTerminal::p1, Terminal::OR, NonTerminal::p2}}}},
    {NonTerminal::p2,
     {{NonTerminal::p2, {NonTerminal::p3}},
      {NonTerminal::p2, {NonTerminal::p2, Terminal::AND, NonTerminal::p3}}}},
    {NonTerminal::p3,
     {{NonTerminal::p3, {NonTerminal::p4}},
      {NonTerminal::p3, {NonTerminal::p3, Terminal::EQ, NonTerminal::p4}},
      {NonTerminal::p3, {NonTerminal::p3, Terminal::NE, NonTerminal::p4}}}},
    {NonTerminal::p4,
     {{NonTerminal::p4, {NonTerminal::p5}},
      {NonTerminal::p4, {NonTerminal::p4, Terminal::LT, NonTerminal::p5}},
      {NonTerminal::p4, {NonTerminal::p4, Terminal::GT, NonTerminal::p5}},
      {NonTerminal::p4, {NonTerminal::p4, Terminal::LE, NonTerminal::p5}},
      {NonTerminal::p4, {NonTerminal::p4, Terminal::GE, NonTerminal::p5}}}},
    {NonTerminal::p5,
     {{NonTerminal::p5, {NonTerminal::p6}},
      {NonTerminal::p5, {NonTerminal::p5, Terminal::PLUS, NonTerminal::p6}},
      {NonTerminal::p5, {NonTerminal::p5, Terminal::MINUS, NonTerminal::p6}}}},
    {NonTerminal::p6,
     {{NonTerminal::p6, {NonTerminal::p7}},
      {NonTerminal::p6, {NonTerminal::p6, Terminal::STAR, NonTerminal::p7}},
      {NonTerminal::p6, {NonTerminal::p6, Terminal::SLASH, NonTerminal::p7}},
      {NonTerminal::p6, {NonTerminal::p6, Terminal::PCT, NonTerminal::p7}}}},
    {NonTerminal::p7,
    ...
    {NonTerminal::p8,
     {
         ...
         {NonTerminal::p8, {Terminal::CHARLITERAL}},
         {NonTerminal::p8, {Terminal::STRLITERAL}},
         {NonTerminal::p8,
          {Terminal::LBRACKET, NonTerminal::optargs, Terminal::RBRACKET}},
         {NonTerminal::p8,
          {Terminal::LBRACKET,
           NonTerminal::optargs,
           Terminal::RBRACKET,
